    ...
    <div id="wrapper">
        ...
        <div>
          ...
          <br>
             ...
             <div style="width: 992px; height: 100px; border: 1px solid lightgrey;">
                  <!-- 여기에 뭘 써야할 지 모르겠으나~! -->
             </div>
      ...
      <table class="tg" style="width: 1020px;" style="text-align: left;">
        <tr>
          <th class="tg-c3ow">적요</th>
          <th class="tg-0pky">금액</th>
          <th class="tg-0pky">수수료</th>
          <th class="tg-0pky">계정과목</th>
        ...
        <tr>
          ...
          <td class="tg-0pky">복리후생비(판)</td>
          <td class="tg-0pky">김밥천국</td>
        </tr>
        <tr>
          <td class="tg-c3ow">합계</td>
          <td class="tg-0pky">5000</td>
          <td class="tg-0pky">0</td>
          <td class="tg-0pky"></td>
          <td class="tg-0pky"></td>
